      ...
      <div style={{ display: "flex", gap: 12, marginBottom: GAP }}>
        ...
        >
          <RefreshCw
            size={16}
            style={{
              animation: syncing ? "ad-spin 1s linear infinite" : "none",
            }}
          />
          Sync GitHub
        </button>
            ...
            >
                ...
                <div>
                  ...
                  <span
                    style={{
                      ...
                      borderRadius: 20,
                      background:
                        project.status === "Deployed" ? "#f0fdf4" : "#fffbeb",
                      color:
                        project.status === "Deployed" ? "#16a34a" : "#d97706",
                    }}
                  >
                    {project.status}
                  </span>
              ...
              <button
                ...
                style={{
                  ...
                  border: "none",
                  cursor: "pointer",
                  color: project.is_featured ? "#f59e0b" : "#cbd5e1",
                }}
              >
                <Star
                  size={18}
                  fill={project.is_featured ? "#f59e0b" : "none"}
                />
              </button>
            </div>
