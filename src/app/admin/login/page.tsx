      ...
      >
        <div className="flex flex-col items-center mb-8">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, var(--ad-primary-500), var(--ad-primary-700))",
        ...
        {!isSupabaseConfigured && (
          <div
            className="mb-6 p-4 rounded-xl text-sm"
            style={{
              background: "var(--ad-success-50)",
              border: "1px solid var(--ad-success-200)",
              color: "var(--ad-success-700)",
            }}
          >
            Supabase is not configured in this environment, so the admin
            dashboard is running in local mode.
          </div>
        )}
