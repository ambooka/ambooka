...
export default function SkillsManager() {
  ...
  const groupedByPhase = filteredSkills.reduce(
    (acc, skill) => {
    ...
    <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        roadmap_phase: Number(e.target.value),
                      })
                    }
                    style={inputStyle}
                  >
              ...
              <div>
                ...
                <input
                  ...
                  style={{ width: "100%", accentColor: "#4A5D45" }}
                />
              </div>
              ...
              >
                <input
                  ...
                  style={{ width: 18, height: 18, accentColor: "#4A5D45" }}
                />
      ...
      <div style={{ marginBottom: GAP + 8 }}>
        ...
        <p style={{ fontSize: 14, color: "#64748b", marginTop: 4 }}>
          Manage your skillset ({skills.length} skills)
        </p>
      </div>
              ...
              {phaseSkills.map((skill) => (
                <div key={skill.id} style={{ ...cardStyle, padding: 16 }}>
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        toggleFeatured(skill.id, skill.is_featured)
                      }
                      style={{
                        background: "none",
                        border: "none",
                        cursor: "pointer",
                        color: skill.is_featured ? "#f59e0b" : "#cbd5e1",
                      }}
                    >
                      <Star
                        size={14}
                        fill={skill.is_featured ? "#f59e0b" : "none"}
                      />
                    </button>
                  </div>
                  <div
                  ...
                  >
                    <div
                      style={{
                        ...
                        background: "linear-gradient(90deg, #4A5D45, #8C7C58)",
                        borderRadius: 2,
                      }}
                    />
                  </div>
      ...
      {filteredSkills.length === 0 && (
        <div style={{ ...cardStyle, padding: 60, textAlign: "center" }}>
          <Code
            size={48}
            style={{ color: "#94a3b8", marginBottom: 16, opacity: 0.3 }}
          />
