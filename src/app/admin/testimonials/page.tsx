    ...
    <div>
      ...
      <div style={{ marginBottom: GAP + 8 }}>
        ...
        <p style={{ fontSize: 14, color: "#64748b", marginTop: 4 }}>
          Manage recommendations ({testimonials.length})
        </p>
      </div>
          ...
          {testimonials.map((testimonial) => (
            ...
            >
                  ...
                  >
                    ...
                    {testimonial.is_featured && (
                      <Star
                        size={14}
                        fill="var(--ad-warning)"
                        style={{ color: "var(--ad-warning)" }}
                      />
                    )}
                  </div>
                  <p style={{ fontSize: 12, color: "var(--ad-text-tertiary)" }}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                <button
                  onClick={() =>
                    toggleActive(testimonial.id, testimonial.is_active)
                  }
                  style={{
                    flex: 1,
                    padding: 10,
                    borderRadius: 10,
                    background: testimonial.is_active
