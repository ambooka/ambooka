...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Portfolio",
    description:
      "Portfolio aligned to the NEXUS program: Cloud, Platform, Security, and MLOps anchor projects and case studies by Msah Ambooka.",
    openGraph: {
      title: "Portfolio | Msah Ambooka",
      description:
        "Recruiter-focused proofs for cloud-native platform engineering, security, and MLOps (NEXUS).",
