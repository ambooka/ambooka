...
export const ROLE_PROFILES: Record<RoleVariant, RoleProfile> = {
  "software-engineer": {
    ...
    professionalSummary:
      "Computer Science graduate with 3+ years of hands-on experience across software engineering, IT infrastructure, and production systems. Delivered full-stack applications, REST APIs, payment integrations, business automation tools, ERP implementation support, and production-oriented platform/MLOps work with Python, TypeScript, PostgreSQL, Docker, OpenCV, and YOLO.",
  },
  ...
  "full-stack": {
    ...
    professionalSummary:
      "Full-Stack Developer with 3+ years building React, Next.js, and Node.js applications for Kenyan and international clients. Specialised in M-Pesa Daraja API integrations, custom business dashboards, and OpenAPI-documented REST services. Delivered 12+ projects on time with 100% client satisfaction. CS graduate transitioning into platform/MLOps engineering through a dedicated professional development plan.",
  },
  ...
  backend: {
    ...
    professionalSummary:
      "Backend Engineer with 3+ years building Node.js, Express, and FastAPI services for production use. Deep experience with M-Pesa Daraja API (STK Push, B2C, webhooks), PostgreSQL schema design, Redis caching, and BullMQ async job queues. Containerised deployments on Nginx-fronted Hetzner VPS with GitHub Actions CI/CD. CS graduate building toward platform/MLOps engineering.",
  },
  ...
  "cloud-mlops": {
    ...
    professionalSummary:
      "Software Engineer and Full-Stack Developer with 3+ years of production-oriented experience across Python, TypeScript, REST APIs, PostgreSQL, Docker, Nginx, GitHub Actions, ERPNext, Windows Server, and platform/MLOps. Strengthening cloud, Kubernetes, Terraform, MLflow, LangChain, pgvector, and AWS through production-grade project work.",
  },
  ...
  "it-assistant": {
    ...
    summaryFocus:
      "delivering exceptional IT support in hospitality environments",
    experienceEmphasis: [
      "support",
      "helpdesk",
      "technical",
...
export function filterSkillsByRole(
  ...
  return skills.filter((skill) => {
    ...
    const isExcludedCategory = profile.excludeCategories.includes(
      skill.category,
    );
    ...
    const isExcludedByName = profile.excludeSkillNames.some((excludedName) =>
      skill.name.toLowerCase().includes(excludedName.toLowerCase()),
    );
...
export function languageMatchesRole(
  ...
  const profile = ROLE_PROFILES[role];
  return profile.languages.some((lang) =>
...
export const PROJECT_FALLBACK_DESCRIPTIONS: Record<string, string> = {
  ambooka:
    "Personal portfolio site built with Next.js 16 and Supabase — features admin CMS, AI-generated resume variants, GitHub sync, and Playwright e2e tests.",
  roadmap:
    "A professional platform/MLOps development plan building from full-stack delivery into applied production engineering practice.",
  storyline:
    "Interactive storytelling platform built with TypeScript — exploring narrative structure and real-time collaborative writing.",
  GenAI:
    "Generative AI experiments: RAG prototypes, prompt engineering studies, and LLM API integrations documented as learning artefacts.",
  Teleboard:
    "Java-based telecommunications dashboard for managing and visualising network operations data.",
  Skytracks:
    "Aviation tracking application built with Java — real-time flight data and route visualisation.",
  charity:
    "Non-profit website template with donation integration and event management.",
  BrigdeOfHope:
    "Community support platform connecting donors with charitable causes.",
  QuranApp:
    "Privacy-focused mobile application for exploring the Holy Quran — ad-free reading experience.",
  Online3DViewer:
    "Browser-based 3D model visualisation tool supporting multiple file formats.",
};
