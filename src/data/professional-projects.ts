...
export const projects: Project[] = [
  ...
  },
  {
    ...
    oneLine:
      "Production TypeScript integration for Safaricom Daraja API with STK Push, B2C, C2B, retries and webhook validation.",
    ...
    solution:
      "Built a typed Daraja API integration layer with STK Push, B2C and C2B flows, retry logic and webhook validation.",
    businessValue:
  ...
  },
  {
    ...
    proof: {
      caseStudy: "/case-studies/computer-vision-surveillance-system",
    },
    engineeringEvidence: {
      tests: false,
      ci: false,
    ...
    recruiterSummary:
      "Built an end-to-end computer vision surveillance system with YOLO, OpenCV, Flask inference API and automated alert generation.",
  },
  {
    slug: "hebatullah-cms-website-rebuild",
    title: "Hebatullah CMS Website Rebuild",
    oneLine:
      "Company website rebuild from static HTML into a CMS-backed system for non-developer content updates.",
    category: "frontend" as ProjectCategory,
    displayOrder: 6,
    status: "completed" as ProjectStatus,
    completionPercent: 100,
  ...
  },
  {
    ...
    oneLine:
      "Ground-up company network and VoIP infrastructure rollout: switches, wireless access points, cabling and desk phones.",
...
export const featuredProjects = projects.filter(
  (project) => project.featured && project.status === "completed",
);
