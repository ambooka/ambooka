...
export const caseStudies: CaseStudy[] = projects.filter((project) => project.featured).map((project) => ({
  slug: project.slug,
  ...
  quality: [
    project.engineeringEvidence.tests ? "Testing evidence is expected or present." : "Testing evidence is limited or not public for this project.",
    project.engineeringEvidence.ci ? "CI/CD evidence is expected or present." : "CI/CD is not public or not applicable for this project.",
    project.engineeringEvidence.deployed ? "Deployment or real operational use is part of the proof." : "Deployment proof is not public or not applicable.",
