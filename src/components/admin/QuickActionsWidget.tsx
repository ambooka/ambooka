  ...
  return (
    <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-[hsl(var(--accent))] text-white rounded-lg font-medium hover:bg-[hsl(var(--primary))] transition-all shadow-sm hover:shadow-md active:scale-[0.98]"
      >
