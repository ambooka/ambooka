...
const blueprints = [
  ...
  },
  {
    ...
    phase: "Phase 3",
    icon: Globe,
    color: "text-[hsl(var(--secondary))] bg-[hsl(var(--secondary)/0.14)]",
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {blueprints.map((project) => (
        <div
          key={project.id}
          className="card p-5 group hover:bg-white transition-colors border border-transparent hover:border-gray-200"
        >
