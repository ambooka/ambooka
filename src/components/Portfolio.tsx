...
const evidenceLabels: Array<
  [keyof FeaturedProject["engineeringEvidence"], string]
> = [
  ["deployed", "Deployed"],
  ["tests", "Tests"],
  ["ci", "CI"],
    ...
    const fetchProjects = async () => {
      ...
      try {
        ...
        const mappedProjects = repos.map((repo) => ({
          ...
          isFeatured:
            repo.stargazers_count >= github.featuredThreshold ||
            !!repo.homepage,
      ...
      >
          ...
          <section className="mb-14" aria-labelledby="featured-work-title">
            <div className="flex flex-col gap-2 mb-6">
              ...
              <p className="text-sm leading-relaxed text-[hsl(var(--muted-foreground))] max-w-[780px]">
                Curated projects with real business context, implementation
                detail, measurable impact, or case-study evidence.
              </p>
            </div>
                    ...
                    <div className="mt-5 flex flex-wrap gap-2.5">
                      ...
                      {project.proof.github && (
                        <a
                          ...
                          className="inline-flex min-h-10 items-center justify-center gap-2 rounded-xl bg-[hsl(var(--muted))] px-4 py-2 text-xs font-bold uppercase tracking-widest text-[hsl(var(--foreground))] shadow-sm transition-colors hover:bg-[hsl(var(--accent))/0.08] hover:text-[hsl(var(--accent))] focus-visible:outline-none focus-visible:ring-0"
                        >
                      ...
                      {project.proof.liveDemo && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="inline-flex min-h-10 items-center justify-center gap-2 rounded-xl bg-[hsl(var(--card))/0.68] px-4 py-2 text-xs font-bold uppercase tracking-widest text-[hsl(var(--foreground))] transition-colors hover:bg-[hsl(var(--accent))/0.08] hover:text-[hsl(var(--accent))] focus-visible:outline-none focus-visible:ring-0"
                        >
        ...
        <section aria-labelledby="repo-archive-title">
          <div className="flex flex-col gap-2 mb-6">
            ...
            <h3
              id="repo-archive-title"
              className="text-2xl font-black tracking-tight text-[hsl(var(--foreground))]"
            >
              Repository Archive
            </h3>
            <p className="text-sm leading-relaxed text-[hsl(var(--muted-foreground))] max-w-[760px]">
              A live archive of public and private development work,
              experiments, and ongoing builds. Featured work above is the
              curated professional layer.
            </p>
          </div>
          ...
          {loading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-5">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="h-[400px] bg-[hsl(var(--muted))] animate-pulse rounded-2xl"
                />
              ))}
            </div>
          ) : error ? (
            <div className="text-center py-20 text-red-500 bg-[hsl(var(--muted))] rounded-2xl border border-red-500/20">
              {error}
            </div>
          ) : (
            <>
              ...
              >
                {paginatedProjects.map((repo, index) => {
                  const pattern = getCardPattern(index);
                  return (
                    <motion.div key={repo.id} variants={staggerChildScale}>
                      <div
                        className={cn(
                      ...
                      >
                        ...
                        <div className="relative flex-1 p-6 flex flex-col z-10">
                          ...
                          <div className="flex justify-between items-start mb-4 gap-2">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                <h3
                                  className="text-base font-bold text-[hsl(var(--foreground))] capitalize truncate"
                          ...
                          <p className="text-sm leading-relaxed text-[hsl(var(--muted-foreground))] line-clamp-3 mb-6 flex-1 opacity-90">
                            {repo.description ||
                              "Integrating complex systems with elegant solutions. This project showcases scalable architecture and modern engineering practices."}
                          </p>
                            ...
                            {!repo.isPrivate ? (
                              <a
                                ...
                                className={cn(
                                  ...
                                  "shadow-sm transition-all hover:bg-[hsl(var(--accent))/0.9] hover:-translate-y-px focus-visible:outline-none focus-visible:ring-0",
                                )}
                              >
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-10 scrollbar-thin scrollbar-thumb-[hsl(var(--border))] scrollbar-track-transparent">
                  {popupLoading ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-4">
                      ...
                      <p className="text-[hsl(var(--muted-foreground))] font-bold uppercase text-xs tracking-widest">
                        Decrypting README...
                      </p>
                    </div>
                  ) : popupError ? (
