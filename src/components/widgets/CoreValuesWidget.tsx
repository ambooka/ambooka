...
export default function CoreValuesWidget() {
  const values = [
    ...
    },
    {
      ...
      title: "Pragmatic MLOps",
      description:
        "Production-ready systems and pipelines that solve real problems.",
    ...
    <div className="w-full">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-3 px-4">
          ...
          <h3 className="text-sm font-black text-[hsl(var(--foreground))] uppercase tracking-[0.2em]">
          ...
          >
            ...
            <div className="relative z-10 flex items-start justify-between mb-4">
              ...
              <div className="text-right opacity-60 group-hover:opacity-100 transition-opacity">
                ...
                <div className="text-[9px] uppercase tracking-widest text-[hsl(var(--muted-foreground))] font-bold">
                  {value.metricLabel}
                </div>
              </div>
            </div>
