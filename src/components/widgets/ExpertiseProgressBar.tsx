...
const SEGMENTS = [
  {
    key: "software",
    label: "Software",
    bgClass: "bg-[hsl(var(--foreground))]",
    borderClass: "border-transparent",
    textClass: "text-[hsl(var(--background))]",
    isStriped: false,
  },
  {
    key: "cloud_infra",
  ...
  },
  {
    ...
    borderClass: "border-dashed border-2 border-[hsl(var(--border))]",
    textClass: "text-[hsl(var(--muted-foreground))]",
    isStriped: false,
  },
];

export const ExpertiseProgressBar = ({
  breakdown,
          ...
          return (
            <div
              ...
              className={cn(
                ...
                seg.borderClass,
                seg.isStriped &&
                  "bg-[linear-gradient(45deg,rgba(255,255,255,0.25)_25%,transparent_25%,transparent_50%,rgba(255,255,255,0.25)_50%,rgba(255,255,255,0.25)_75%,transparent_75%,transparent)] bg-[length:20px_20px]",
              )}
              style={{
                width: `${(value / total) * 100}%`,
