    ...
    return (
      <div
        className={cn(
          ...
          embedded
            ? "rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))/0.5] p-6"
            : "rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--card))/0.8] backdrop-blur-xl p-12 shadow-sm",
        )}
      >
  ...
  return (
    <div
      className={cn(
        "group/main h-full",
        !embedded &&
          "rounded-3xl border border-[hsl(var(--border))] bg-[hsl(var(--card))/0.8] backdrop-blur-xl shadow-sm",
      ...
      >
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            {!compact && (
              <p className="text-[11px] font-[900] uppercase tracking-[0.18em] text-[hsl(var(--muted-foreground))] mt-0.5">
                ...
                <div className="relative z-10 h-full flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex gap-1.5 shrink-0 ml-3">
                      ...
                      >
                        <Star
                          size={embeddedCompact || compact ? 12 : 14}
                  ...
                  <p
                    className={cn(
                      ...
                      embeddedCompact || compact
                        ...
                        : "text-sm sm:text-[0.95rem] line-clamp-3 mb-5",
                    )}
                  >
                    {project.description}
                  </p>
                  ...
                  <div className="flex gap-2">
                    <a
                      ...
                      className={cn(
                        "rounded-full bg-[hsl(var(--accent))] text-white font-black uppercase tracking-widest flex min-h-10 items-center gap-2 transition-all hover:bg-[hsl(var(--accent))/0.9] hover:scale-[1.02] shadow-md",
                        embeddedCompact || compact
                          ? "px-3 py-2 text-[9px]"
                          : "px-4 py-2.5 text-[10px]",
                      )}
                    >
                      <Github size={embeddedCompact || compact ? 13 : 15} />{" "}
                      Repository
                    </a>
                    {project.homepage && (
                      <a
                      ...
                      >
                        <ExternalLink
                          size={embeddedCompact || compact ? 14 : 15}
                        />
                      </a>
                    )}
                  </div>
