    ...
    ? [
        {
          ...
          colorClass: "text-[hsl(var(--accent))] bg-[hsl(var(--accent)/0.12)]",
        },
        ...(personalInfo.phone
          ? [
              {
          ...
          ? [
              {
                ...
                colorClass:
                  "text-[hsl(var(--secondary))] bg-[hsl(var(--secondary)/0.14)]",
              },
            ]
          : []),
      ]
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[0.75rem] font-semibold text-[hsl(var(--muted-foreground))] mb-1 uppercase tracking-wider">
                      {method.label}
                    </div>
                    <div className="text-[0.875rem] font-bold text-[hsl(var(--foreground))] truncate leading-tight group-hover:text-[hsl(var(--accent))] transition-colors">
                      {method.value}
                    </div>
                  </div>
                </motion.a>
